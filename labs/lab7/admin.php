...
<html>
    ...
    <body>
        ...
        <h1><font color="green" class="col-md-4 col-md-offset-4">Admin Main Page</font> </h1>
        </div>
        <h3><font color="green" class="col-md-4 col-md-offset-4">Welcome <?php echo "Niccolo's TA"?>!</font></h3>
        
        <br />
        <div class="container">
        <form action="addProduct.php" class="col-md-4">
            <!--<input type="submit" name="addproduct" value="Add Product"/> -->
            <button type="submit" class="btn btn-primary" value="Add Product">Add Product</button>
        </form>
        <form action="logout.php"class="col-md-4 col-md-offset-4">
